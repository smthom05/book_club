...
Review.create(tite: "Awesome Book", rating: 5, text: "This book was awesome!!! Must Read!", user: user_1, book: book_1)
Review.create(tite: "Great Book", rating: 5, text: "Mountain climbing sounds hard", user: user_1, book: book_11)
Review.create(tite: "Awful Book", rating: 1, text: "WASTE OF TIME!", user: user_2, book: book_2)
Review.create(tite: "DINOSAURS!", rating: 4, text: "Dinosaurs are pretty kewl.", user: user_3, book: book_5)
Review.create(tite: "Dragons are cool.", rating: 5, text: "YAY Dragons!", user: user_7, book: book_12)
Review.create(tite: "Charizard is cooler...", rating: 3, text: "Charizard would win in a fight with these dragons.", user: user_8, book: book_12)
Review.create(tite: "This book is scary.", rating: 2, text: "Is Peter Okay?", user: user_5, book: book_7)
Review.create(tite: "Everything floats down here.", rating: 5, text: "Chilling", user: user_4, book: book_6)
Review.create(tite: "Red rum", rating: 5, text: "Here's Johnny!", user: user_4, book: book_7)
Review.create(tite: "Let's do this!", rating: 1, text: "Not enough patience to finish the book.", user: user_6, book: book_10)
